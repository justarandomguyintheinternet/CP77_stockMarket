local localization = {
    ...
    ["stockInfo_Dynalar"] = "Dynalar Technologies is a cyberware manufacturing corporation. They makes cyberware implants and specialize in chrome plated cybernetic arms for women. Many famous BD stars wear chrome plated arms built by Dynalar.",
