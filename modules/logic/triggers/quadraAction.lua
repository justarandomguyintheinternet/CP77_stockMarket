...
function trigger:registerObservers() -- Gets called once onInit
    Observe("VehicleComponent", "StealVehicle", function(this)
        ...
        self.cooldown = true
        if this:GetVehicle():GetRecord():Manufacturer():Type() ~= gamedataVehicleManufacturer.Quadra then return end
    ...
    Cron.Every(5, function ()
        ...
        if veh ~= nil then
            if veh:GetRecord():Manufacturer():Type() ~= gamedataVehicleManufacturer.Quadra then return end
